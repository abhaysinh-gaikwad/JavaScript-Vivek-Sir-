...
// let itemOne_1 =  document.querySelector('.item');
// console.log(itemOne_1);

// let itemOne1 =  document.querySelectorAll('.item');
...
// let newwHeadingText = document.createTextNode("This is my Titile");
// newHeading.appendChild(newwHeadingText);
